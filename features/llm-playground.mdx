...
<Card>
  <img src="https://media.productgraph.ai/playground.gif" />
</Card>

## Conversation

Product Graph enables interactive conversations with a configured model. This allows you to test various prompt variations or engage in a conversation to observe the model's responses to different inputs before developing your evaluations and deploying the prompt to production.
...
Product Graph allows you to compare multiple different prompt configurations side by side.
