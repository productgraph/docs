...
This header scopes all operations to your specific workspace. You can find your organization ID in the [MCP Connection modal](https://app.productgraph.ai?modal=MCP_CONNECTION) in Product Graph.
